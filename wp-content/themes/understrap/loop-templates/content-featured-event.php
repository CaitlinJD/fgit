...
=======
                    ...
                    <?php echo (is_front_page()? "<h2 class='red-font'>" : ((is_tax('partnercategory', 'mentors'))? "<h1 class='col-xs-12 col-sm-9 col-md-10 red-font'> " : "<h1 class='red-font col-xs-12 col-sm-8 col-md-7'>")); ?>
                        <?php the_title() ?>
